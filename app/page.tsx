...
const HeroScene = dynamic(
  () =>
    import("@/components/3d/hero-scene").then((mod) => ({
...
const HeroControlPanel = dynamic(
  () =>
    import("@/components/customization/hero-control-panel").then((mod) => ({
      default: mod.HeroControlPanel,
    })),
  {
    ssr: false,
  }
            ...
            <div ref={heroRef} className="space-y-10">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight">
                  Build with{" "}
                  <span className="gradient-text block">Interactive 3D</span>
                  Components
                </h1>

                <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl">
                  ZAxis is the most advanced 3D component library for modern web
                  development. Visualize, customize, and export production-ready
                  Three.js components with real-time controls and instant code
                  generation.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Link href="/browse">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto text-lg px-8 py-4 glow-primary group btn-glow"
                  >
                ...
                <Link href="/viewer">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full sm:w-auto text-lg px-8 py-4 border-primary/30 hover:border-primary/60"
                  >
          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold mb-6">
                Customize in <span className="gradient-text">Real-Time</span>
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
                Experience the power of live 3D customization. Modify colors,
                lighting, animations, and effects in real-time, then export the
                code instantly.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Professional-grade tools designed for developers and designers who
              demand the best in 3D web development
            </p>
          </div>
          ...
          >
            ...
            <Card className="glass-morphism hover-glow floating-card group card-hover">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Optimized for performance with efficient rendering, lazy
                  loading, and minimal bundle size impact.
                </p>
                <div className="flex justify-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Carefully crafted 3D components organized by category for easy
              discovery
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Join thousands of developers building the future of 3D web
              experiences
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-morphism text-center p-8 card-hover">
              ...
              <p className="text-muted-foreground mb-4">
                "ZAxis has revolutionized our 3D development workflow. The code
                generation feature alone saves us hours every week."
              </p>
            ...
            <Card className="glass-morphism text-center p-8 card-hover">
              ...
              <p className="text-muted-foreground mb-4">
                "Outstanding performance and beautiful components. The
                documentation and examples make it easy to get started."
              </p>
        ...
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="glass-morphism p-16 rounded-3xl glow-primary">
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
              Start creating stunning 3D experiences today. Join thousands of
              developers who are already building the next generation of web
              applications with ZAxis.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link href="/browse">
                <Button
                  size="lg"
                  className="text-xl px-12 py-6 glow-primary group btn-glow"
                >
