    ...
    <group ref={groupRef}>
      <Float speed={customization.floatSpeed} rotationIntensity={1} floatIntensity={2}>
        ...
        <Float speed={2} rotationIntensity={2} floatIntensity={1}>
          <Sphere args={[customization.sphere1Scale]} position={customization.sphere1Position} castShadow>
        ...
        <Float speed={1.8} rotationIntensity={1.5} floatIntensity={1.5}>
          <Sphere args={[customization.sphere2Scale]} position={customization.sphere2Position} castShadow>
            <meshStandardMaterial
        ...
        <Float speed={2.2} rotationIntensity={0.8} floatIntensity={2.5}>
          <Sphere args={[customization.sphere3Scale]} position={customization.sphere3Position} castShadow>
            <meshStandardMaterial
